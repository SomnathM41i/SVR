...
<head>
  ...
  <title>Profile I Have Ignore</title>
...
$sqlview = mysqli_query($con,"SELECT * FROM `ignore` where  matriid='$login' And  profile_id  NOT IN('$profile') And  profile_id  NOT IN ('$matriid') and banstatus!='1' LIMIT $start_from, $limit ");
$sql1="SELECT COUNT(*) FROM  `ignore` where  matriid='$login' And  profile_id  NOT IN('$profile') And  profile_id  NOT IN ('$matriid') and banstatus!='1' ";
...
<main class="mvv-page">
  <section class="mvv-page-hero">
    <div class="mvv-container">
      <div class="mvv-eyebrow">Ignored</div>
      <h1>Profile I Have Ignore</h1>
      <p>दुर्लक्षित प्रोफाइल</p>
      <nav class="mvv-breadcrumb" aria-label="breadcrumb">
        <a href="index_dashboard">Home</a>
        <span>Profile I Have Ignore</span>
      </nav>
    </div>
  </section>
                ...
                <div class="speaker-block col-xl-3 col-lg-4 col-md-6 col-sm col-6">
                    <div class="inner-box">
                       ...
                       <div class="info-box">
							...
							<span class="designation">Date: <?php echo $rowview['when1'];?> </span>
                            </div>
							</a>
                        </div>
                    </div>
			 ...
			 <?php if($limit<$total_records) { ?>  
						...
						<div align="center" class="col-lg-12">
							...
							<?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
										if($i == $_GET['page']):?>
									   <li class='active' id="<?php echo $i;?>"><a  class='active' href='profile_ignore?page=<?php echo $i;?>' ><?php echo $i;?></a></li> 
										
										<?php else:?>
										<li id="<?php echo $i;?>" ><a href='profile_ignore?page=<?php echo $i;?>' ><?php echo $i;?></a></li>
							...
							if($page < $total_pages){ 
								...
								<li id="<?php echo $i;?>"><a href='profile_ignore?page=<?php echo $next;?>' ><span class="icon fa fa-angle-right"></span></a></li>
							</a></li>
							<?php }         ?><?php endif;?> 
							 </ul>
							 </div></div>
        ...
        <span>Profile I Have Ignore</span>
			...
			<section class="mvv-section">
					...
					<div class="auto-container">
						...
						<div class="text">You dont have ignored any profile.</div>
