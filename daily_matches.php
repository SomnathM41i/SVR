...
$match_qry="select DISTINCT * from register where visibility NOT LIKE 'hidden' AND MatriID NOT LIKE '$login' AND Regdate > DATE_SUB( NOW( ),INTERVAL 1 DAY) AND ";
if($profile!="")
{
...
$count="select COUNT(*) as totalCount from register where visibility NOT LIKE 'hidden' AND MatriID NOT LIKE '$login' AND Regdate > DATE_SUB( NOW( ),INTERVAL 1 DAY) AND ";
if($profile!="")
{
		...
		?>
                ...
                <div class="speaker-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        ...
                        <div class="info-box">
                            <div class="inner">
                                <h4 class="name"><a href="speakers-detail.html"><?php echo $fetch['MatriID']?></a></h4>
                                ...
                                <ul class="social-links social-icon-colored" style="margin-top:5px;display:flex;justify-content:center;">
                                    <li><?php
