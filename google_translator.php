<style>
.mvv-translate-widget{position:fixed;right:14px;bottom:140px;z-index:1080}.mvv-translate-toggle{width:68px;height:62px;padding:7px 6px;border:0;border-radius:14px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2px;background:linear-gradient(135deg,#C9921A,#f0bd3d);color:#6B1A1A;box-shadow:0 8px 28px rgba(0,0,0,.2);cursor:pointer}.mvv-translate-toggle:hover{transform:translateY(-3px);box-shadow:0 12px 36px rgba(0,0,0,.3)}.mvv-translate-toggle i{font-size:20px;line-height:1}.mvv-translate-label{font-size:10px;line-height:1.1;font-weight:800;text-transform:uppercase;letter-spacing:.03em}.mvv-translate-menu{position:absolute;right:0;bottom:calc(100% + 9px);width:155px;display:none;padding:7px;border:1px solid #e0d5cb;border-radius:12px;background:#fff;box-shadow:0 14px 38px rgba(58,42,34,.2)}.mvv-translate-widget.open .mvv-translate-menu{display:grid;gap:4px}.mvv-translate-menu button{display:flex;align-items:center;gap:9px;width:100%;padding:9px 10px;border:0;border-radius:8px;background:transparent;color:#49393a;text-align:left;font:inherit;font-size:13px;cursor:pointer}.mvv-translate-menu button:hover{background:#FFF8F0;color:#6B1A1A}.mvv-translate-menu button span{display:grid;place-items:center;width:25px;height:25px;border-radius:50%;background:#fff0e0;font-size:11px;font-weight:800}#google_translate_element{position:absolute!important;width:1px!important;height:1px!important;overflow:hidden!important;opacity:0!important;pointer-events:none!important}.goog-te-gadget,.goog-logo-link{display:none!important}@media(max-width:700px){.mvv-translate-widget{right:8px;bottom:140px}.mvv-translate-toggle{width:60px;height:58px}}
</style>
