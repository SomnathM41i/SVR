...
<style>
:root{--mvv-maroon:#5E1426;--mvv-saffron:#C9556A;--mvv-gold:#BA9350;--mvv-cream:#FFFDFB;--mvv-muted:#888;}
...
.mvv-btn.primary:hover{background:#7A1F39;transform:translateY(-1px);box-shadow:0 4px 12px rgba(94,20,38,0.3);}
</style>
</head>
<body>
