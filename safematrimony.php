<?php 
	...
	$qry1 = "SELECT * FROM cms WHERE link ='safematrimony'";
	$result=mysqli_query($con,$qry1)or die(mysql_error());
	$row = mysqli_fetch_array($result);
	$txt = $row['content'];
    $seo=mysqli_query($con,"Select * from seo where catagory='safe_matrimony'");
...
<div class="page-wrapper bg-light">
    ...
    <section class="page-title" style="background-image:url(images/background/5.jpg);">
        <div class="auto-container">
            <h1 class="d-none d-lg-block d-xl-block d-md-block">Safe-Matrimony</h1>
            ...
            <div class="row">
                ...
                <div class="content-column col-lg-12 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="sec-title">
                            <span class="title">Safe-Matrimony</span>
							<?php echo $txt?>
