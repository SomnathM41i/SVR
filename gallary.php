...
xmlhttp.send();
window.location='gallary.php?flag=1';}
        ...
        <div class="auto-container">
						 ...
						 <div class="auto-container">
							...
							<?php  while($row=mysqli_fetch_array($sqlgal))	 { ?>
								...
								<div class=" col-lg-4 col-md-6 col-sm-12 wow fadeIn">
									<div class="">
										<figure class=""> <a href="gallary/<?php echo $row['photo_name'];?>" data-sub-html="Demo Description">
											<div class=""></div>
										 <img src="gallary/<?php echo $row['photo_name'];?>" class="img-thumbnail"></a> </figure>
									</div>
									 <?php
           ...
           <div class="row">
             <div class="jsdemo-notification-button12" id="dpchange<?php echo $row['photo_id'] ?>">
                  <button type="button" id="dp1" onclick="dp(<?php echo $row['photo_id']?>)" class="btn btn-default pull-left disabled btngal" > <strong>Profile Picture</strong></button>
                </div>
                <div class=" jsdemo-notification-button13">
                  <button type="button" id="delete" onClick="deletephoto(<?php echo $row['photo_id']?>)" class="btn btn-default pull-left disabled btndel"  > Delete Photo</button>
                </div>
				 </div>
                <?php 
                ...
                <?php }
						...
						{ 
							...
							<button type="button" id="dp" onclick="window.location='upload_photo_gallary?id=<?php echo $row['photo_id']?>'" class="btn btn-default pull-left disabled btngal1" > <strong>Selected Profile Picture</strong></button>
							</div>
							<?php 
									$is_protected =$row['photo_protect'];
