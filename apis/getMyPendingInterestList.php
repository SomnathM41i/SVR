...
$countSql = "SELECT COUNT(*) as total 
             ...
             WHERE eisender = ? AND status = 'Pending' AND banstatus != '1' $whereNotIn";
...
echo json_encode([
    "status" => "success",
    "message" => !empty($profiles) ? "Pending express interest requests fetched successfully" : "No pending express interest requests found",
    "pagination" => [
        "current_page" => $page,
