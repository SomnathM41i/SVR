...
<div class='logo' style='float: left;
	...
	text-decoration: none;'><img src='https://weddingsparampara.com/branding/images/logo-horizontal.png'></a></div>
...
May your birthday be filled with many happy hours and your life with many happy birthdays. HAPPY BIRTHDAY !!<br>

On this special day, we suggest you to invite all your friends, colleagues and all known people to visit 
<a href='#' class='color-2' style='color: #c5191f;transition: all 0.3s ease-in-out;
	-webkit-transition: all 0.3s ease-in-out;
	-moz-transition: all 0.3s ease-in-out;
	-ms-transition: all 0.3s ease-in-out;
	-o-transition: all 0.3s ease-in-out;
	text-decoration: none;'>weddingsparampara.com</a> & expand your search base of 
matching profiles. 
</p>
</div>
