...
<section class="page-title" style="background-image:url(images/background/5.jpg);">
        <div class="auto-container">
            <h1> My Shortlist Profile</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="index.html">Home</a></li>
                <li>My Shortlist Profile</li>
            </ul>
        </div>
</section>
<?php
...
$sqlview = mysqli_query($con,"SELECT * FROM shortlist_profile where mat_id ='$login' And  profile_id  NOT IN('$profile') And  profile_id  NOT IN ('$matriid') LIMIT $start_from, $limit ");
$sql1="SELECT COUNT(*)  as totalCount FROM shortlist_profile where mat_id ='$login' And  profile_id  NOT IN('$profile') And  profile_id  NOT IN ('$matriid')";
...
<section class="speakers-section">
	 ...
	 while($rowview=mysqli_fetch_array($sqlview))
			  {
                ...
                <div class="speaker-block col-xl-3 col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image-box">
                          <figure class="image">
                            <a href="full_profile?id=<?php echo $rec['MatriID']?>" target="_blank">							
							<?php if($rec['Photo1Approve']=='Yes')
							{
							if($rec['Photo1']!='no-photo.gif') {
								 ?>		
                       ...
                       <div class="info-box">
                            <div class="inner">
                              <h4 class="name"><a href="speakers-detail.html"><?php echo $rec['MatriID']?></a></h4>
	...
	<div class="course-w3ls py-4">
    <div class="container py-xl-8 py-lg-3">
    <div class="col-md-12">
    <div class="alert alert-info" align="center" role="alert">
  
    <?php 
       echo "You have not yet connected profiles.";?> <a href="smart_search">Search Here</a>
     </div>
	 <?php } ?>
   </div>
 </div>
