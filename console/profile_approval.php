            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Profile Description Approval</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
                                 <?php  
                                  $profile_approve = mysqli_query($con,"SELECT * FROM register where profile_approve='No' and aboutus!=''order by id desc");
                                        ...
                                        if(mysqli_num_rows($profile_approve))
                                        {
                                            ...
                                            ?>
                                            <tr>
                                              <td><a href="profile_view?ID=<?php echo $profile_approve_row['MatriID']; ?>"><?php  echo $profile_approve_row['MatriID'];?></a></td>
                                                <td><?php  echo $profile_approve_row['Name'];?></td>
                                                <td><?php  echo $profile_approve_row['Mobile'];?></td>
                                                <td align="center"><a href="#" data-bs-toggle="modal" data-bs-target="#modal-report2" data-id="<?php  echo $profile_approve_row['MatriID'];?>" class="btn btn-success btn-md">View</a></td>
                                            </tr>
                                            <?php  
                                             }
                                        }?>
...
<?php if(isset($_POST['submit'])){ ?>
  ...
  <div id="myModal6" class="modal " role="dialog" style="margin-top: 100px;">
  <div class="modal-dialog">
...
<div class="swal2-success-circular-line-left" style="background-color: rgb(255, 255, 255);"></div>
    ...
    <h2 class="swal2-title" id="swal2-title" style="display: flex;">Profile Description Approved Successfully</h2>
    </div>
    <div class="swal2-actions">
    
    <a href="profile_approval" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
      </div>
    </div> 
</div>
</div>   
...
<div class="swal2-success-circular-line-left" style="background-color: rgb(255, 255, 255);"></div>
    ...
    <h2 class="swal2-title" id="swal2-title" style="display: flex;">Profile Description Declined Successfully</h2>
    </div>
    <div class="swal2-actions">
