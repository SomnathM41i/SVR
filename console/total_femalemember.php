...
require_once(dirname(__FILE__).'/protect.php');
  ...
  error_reporting(0);
  $result=mysqli_query($con,"SELECT * FROM register where Gender='Female' order by ID desc");
?>
...
<head>
    ...
    <title>Total Female Member</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Total Female Member</h5>
                    </div>
                    <div class="card-body">
                           <div class="dt-responsive table-responsive">
                            <table id="simpletable_female" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
