...
<head>
	...
	.member-list-container .pc-container,
	.member-list-container .pcoded-content {
	...
	.member-list-container .table-responsive {
		overflow-x: auto;
	}
                           ...
                           <div class="dt-responsive table-responsive">
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                   ...
                                   <?php
                                   $result=mysqli_query($con,"SELECT * FROM register where Gender='Male' order by ID desc");
