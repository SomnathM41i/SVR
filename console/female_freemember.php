...
require_once(dirname(__FILE__).'/protect.php');
  ...
  error_reporting(0);
  $result=mysqli_query($con,"SELECT * FROM register where Status ='Active' and Gender='Female' order by ID desc");
?>
...
<head>
    ...
    <title>Free Female Member</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Free Female Member</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable_free_FE" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
