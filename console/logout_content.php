...
<?php if(isset($_POST['submit']))
                                    {
                                        ...
                                        $upd_about ="update cms set content = '$content' where cms_id='21'";
                                        mysqli_query($con,$upd_about);
                                        //header('location:logout_content.php?msg=logout');
...
<head>
    ...
    <title>Add Logout Content</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container">
                            ...
                            <?php  $qry="select * from cms where cms_id='21'";
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#!">Logout Content</a></li>
            ...
            <div class="modal-body modalb">  
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Logout Content Updated Successfully</h2>
                    </div>
                    <div class="swal2-actions">
                       <a href="logout_content" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
