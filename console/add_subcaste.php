...
if(isset($_POST['Update']))
{
  ...
  {   
    ...
    $q1="select * from religion order by Religion ASC";
...
xmlhttp.open("GET","fill_caste?q="+str,true);
xmlhttp.send();
...
xmlhttp.open("GET","get_subcaste?id="+id,true);
xmlhttp.send();
            ...
            <div class="card-body">
              <div class="row align-items-center m-l-0">
                ...
                <div class="col-sm-6 text-end">
                  <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add Subcaste</button>
                </div>
                <div class="col-sm-12 ">
                  <form  name="religion" id="religion" method="post" action="add_subcaste">
                    <select  class="mb-3 form-control"  name="religion" type="select" id="religion"  required="required" onChange="fillcaste(this.value);">
                      <div align="" class=""> 
                        <?php  
                          echo $msg; 
                    ...
                    <select  class="mb-3 form-control"  name="caste" type="select" id="caste"  required="required" onChange="get_subcaste(this.value);">
        ...
        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
          <div class="swal2-header">
	        ...
	        <div class="swal2-actions">
	          <a href="add_subcaste" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
          </div>
        </div> 
      </div>
    </div>   
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                  ...
                  <?php 
                    ...
                    {
                  ?>
	                <h2 class="swal2-title" id="swal2-title" style="display: flex;">Subcaste Inactivated Successfully</h2>
                  <?php
                    }
                    else
                    {
                  ?>
                  <h2 class="swal2-title" id="swal2-title" style="display: flex;">Subcaste Activated Successfully</h2>
                  <?php
                    }
                  ?>
                  </div>
