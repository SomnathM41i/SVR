                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
								<?php  
										  $allrec=mysqli_query($con,"select * from e_country");
											...
											<tr>
											    ...
											    <td >
											        ...
											        <?php
                                                        ...
                                                        {
                                                    ?>
                                                    <a href="delete_country?flag=1&id=<?php echo $data['country'];?>" class="btn btn-danger btn-sm ml-3" >Inactivate</a>
                                                    <?php
                                                        }
                                                        else
                                                        {
                                                    ?>
                                                    <a href="delete_country?flag=0&id=<?php echo $data['country'];?>" class="btn btn-danger btn-sm ml-3" >Activate</a>
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
	                ...
	                <div class="swal2-actions">
	                   <a href="add_country" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php
                            ...
                            {
                        ?>
	                    <h2 class="swal2-title" id="swal2-title" style="display: flex;">Country Inactivated Successfully</h2>
	                    <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Country Activated Successfully</h2>
	                    <?php
                            }
                        ?>
                    </div>
