        ...
        <?php  
			 ...
			 <?php  $lookingage="select * from register where MatriID='".$full_profile_fetch['MatriID']."' and Age Between '".$me['PE_FromAge']."' and '".$me['PE_ToAge']."'";
			   ...
			   <!-- end age-->
			   <!-- height-->
			<?php  $lookingheight="select * from register where MatriID='$id_temp' and Height Between '".$me['PE_from_Height']."' and '".$me['PE_to_Height']."'";
			...
			<?php  
              ...
              <?php  
               $looking="select * from register where MatriID='$id_temp'"; 
				...
				?>
				<div class="overflow-y: scroll; position: absolute; top: 0; right:0; bottom: 0; left: 0;">
					<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone" > Looking For: </td>
                    <td class="pb-0" width="30%"> <?php if($complfetch['Looking'] == '') { echo "Not Set"; } ?><?php echo substr($complfetch['Looking'],0,10);?></td>
                    <td class="pb-0"> 
                    	<?php if($count_lok!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				...
				<tr>
                    ...
                    <td class="pb-0"><?php if($complfetch['PE_Religion'] == '') { echo "Not Set"; } ?> <?php echo substr($complfetch['PE_Religion'],0,10);?></td>
                    <td class="pb-0"> 
                    	<?php if($count_religion!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>

				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> Caste: </td>
                    <td class="pb-0"><?php if($complfetch['PE_Caste'] == '') { echo "Not Set"; } ?> <?php echo substr($complfetch['PE_Caste'],0,10);?></td>
                    <td class="pb-0"> 
                    	 <?php if($count_caste!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> Complexion: </td>
                    <td class="pb-0"><?php if($complfetch['PE_Complexion'] == '') { echo "Not Set"; } ?>  <?php echo substr($complfetch['PE_Complexion'],0,10);?></td>
                    <td class="pb-0"> 
                    	 <?php if($count_comp!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> Residency Status: </td>
                    <td class="pb-0"><?php if($complfetch['PE_Residentstatus'] == '') { echo "Not Set"; } ?>  <?php echo substr($complfetch['PE_Residentstatus'],0,10);?></td>
                    <td class="pb-0"> 
                    	 <?php if($count_resident!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> Eduaction: </td>
                    <td class="pb-0"><?php if($complfetch['PE_Education'] == '') { echo "Not Set"; } ?>  <?php echo substr($complfetch['PE_Education'],0,10);?></td>
                    <td class="pb-0"> 
                    	<?php if($count_edu!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> Occupation: </td>
                    <td class="pb-0"><?php if($complfetch['PE_Occupation'] == '') { echo "Not Set"; } ?>  <?php echo substr($complfetch['PE_Occupation'],0,10);?></td>
                    <td class="pb-0"> 
                    	<?php if($count_occu!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> Country:  </td>
                    <td class="pb-0"><?php if($complfetch['PE_Countrylivingin'] == '') { echo "Not Set"; } ?><?php echo substr($complfetch['PE_Countrylivingin'],0,10);?>  </td>
                    <td class="pb-0"> 
                    	<?php if($count_country!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
				<tr>
                    <td class="pl-0 f-w-500 pb-0 aligntone"> State:</td>
                    <td class="pb-0"><?php if($complfetch['PE_State'] == '') { echo "Not Set"; } ?><?php echo substr($complfetch['PE_State'],0,10);?>  </td>
                    <td class="pb-0"> 
                    	<?php if($count_state!='1'){?> <i class="far fa-check-circle ticks"></i> <?php } else {?> <i class="far fa-check-circle tick"></i> <?php }?>
                 	</td>
				</tr>
