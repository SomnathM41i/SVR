...
<head>
    ...
    <title>SEO Google Analytic</title>
                    ...
                    <div class="card-body">
                        <div class="container">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Google Analytic</li>
							</ol>
						</nav>
                                <!--<label class="form-label" for="exampleInputPassword1">Description</label>-->
								  <div class="col-sm-12">
                                           ...
                                           <textarea class="form-control" name="keyword" rows="5" placeholder="Google Analytic" onkeyup="nospaces(this);nospaceses(this);nospaceses1(this)"><?php echo$res['keyword'];?></textarea>
								 </div><br>
            ...
            <div class="modal-body modalb">
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
	                ...
	                <div class="swal2-actions">
	                   <a href="googleanalytic?catagory=googleanalytic" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
