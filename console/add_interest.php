...
{
    $interest=mysqli_real_escape_string($con,$_POST['Name']);
    //echo $caste;
    
    //$Religion=mysqli_real_escape_string($con,$_POST['religion']);
    //echo $Religion;
    
    $q="select * from interest where interest='$interest'";
    ///echo "select * from interest where interest='$interest'";
    ...
    if($num>0)
    {
        ...
        $msg="Interest Field already Exist!!";
    }
    else
    {
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add Interest</button>
                            </div>
                        ...
                        <div class="table-responsive"  id="content">
                            ...
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <?php  
                                          ...
                                          $allrec=mysqli_query($con,"select * from interest");
                                           ...
                                           ?>
                                            <tr>
                                              ...
                                              <?php
                                                ...
                                                {
                                              ?>
                                              <a href="delete_interest?flag=1&id=<?php echo $data['interest'];?>" class="btn btn-danger btn-sm ml-3">Inactivate</a></td>
                                            <?php
                                                }
                                                else
                                                {
                                            ?>
                                                <a href="delete_interest?flag=0&id=<?php echo $data['interest'];?>" class="btn btn-danger btn-sm ml-3">Activate</a></td>
...
$(document).ready(function(){
    $('#modal-report').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'add_interest_pop', //Here you will fetch records 
...
$(document).ready(function(){
    $('#modal-report2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'edit_interest_pop', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.modal-content').html(data);//Show fetched data from database
            }
...
<div id="interestModal" class="modal " role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">   
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    ...
                    <div class="swal2-actions">
                        <a href="add_interest" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php
                            ...
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Interest Inactivated Successfully</h2>
                        <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Interest Activated Successfully</h2>
