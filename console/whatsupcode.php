...
<?php  
    ...
    if(isset($_POST['submit']))
    {
        ...
        $upd_about ="update seo set keyword='$keyword' where catagory='$catagory'";
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container">
							...
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="#!">Plugein</a></li>
								<li class="breadcrumb-item active" aria-current="page">Whatsup Code</li>
							</ol>
						</nav>
                                <!--<label class="form-label" for="exampleInputPassword1">Description</label>-->
								  <div class="col-sm-12">
                                       
                                           <label class="form-label">Whatsup Code:</label>
                                           <textarea class="form-control" name="keyword" rows="5" maxlength="80" placeholder="Whatsup Code" onkeyup="nospaces(this);nospaceses(this);nospaceses1(this)"><?php echo$res['keyword'];?></textarea>
								 </div><br>
								  
                                   
                            </div>
							
                            <button type="" class="btn btn-primary" id="update" name="submit">Update</button>
                        </form>
            ...
            <div class="modal-body modalb">
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
	                ...
	                <div class="swal2-actions">
	                   <a href="whatsupcode?catagory=whatsupcode" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
