...
?>
                            ...
                            <table id="report-table" class="table table-bordered table-striped mb-0">
								...
								<?php  
										  ...
										  $allrec=mysqli_query($con,"select * from e_dist where sid2='$id'");
											...
											<tr>
											  ...
											  <td >
											  	...
											  	<?php
													...
													{
												?>
												<a href="delete_dist?flag=1&id=<?php echo $data['id'];?>" class="btn btn-danger btn-sm ml-3" >Inactivate</a></td>
												<?php
													}
													else
													{
												?>
												<a href="delete_dist?flag=0&id=<?php echo $data['id'];?>" class="btn btn-danger btn-sm ml-3" >Activate</a></td>
												<?php
													}
												?>
											</tr>
