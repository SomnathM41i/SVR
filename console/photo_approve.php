...
include('protect.php');
 ...
 if(isset($_GET["page"]))
    ...
    $sql = mysqli_query($con,"SELECT a.*,b.* FROM register a,gallary b WHERE a.photo1=b.photo_name and a.Photo1Approve='No'  order by id desc LIMIT ".$pageLimit." , ".$setLimit); 

function displayPaginationBelow($con,$per_page,$page){
$page_url="?";
$sql1 = mysqli_query($con,"SELECT COUNT(*)  as totalCount FROM register a,gallary b WHERE a.photo1=b.photo_name and a.Photo1Approve='No'");
                    ...
                    <div class="card-body">
                        <div class="grid row">
                            ...
                            <div class="col-xl-3 col-md-4 col-sm-6 element-item graphic">
                                ...
                                <img name="photo" class="img-fluid img-thumbnail mb-3" src="../photoprocess.php?image=gallary/<?php  echo $row['photo_name']?>&square=700" alt="Card image" border="0"/>

                                
                                <a href="dp_approve?matriid=<?php echo $row['MatriID']; ?>&id=<?php echo $row['photo_id'];?>" class="btn btn-icon btn-outline-success"><i class="fa fa-check" aria-hidden="true"></i></a> &nbsp;&nbsp;
                                <a class="btn btn-icon btn-outline-secondary" onClick="MM_openBrWindow('realcrop?matid=<?php   echo $row['MatriID']?>&Choice=1&op=<?php  echo $row['Photo1'] ?>&photoid=<?php  echo $row['photo_id'] ?>','editphotosize','scrollbars=yes,resizable=yes,width=550,height=600')"><i class="fa fa-crop" aria-hidden="true"></i></a> &nbsp;&nbsp;
                                    
                                <a href="dp_unapprove?matriid=<?php echo $row['MatriID'];?>&id=<?php echo $row['photo_id']; ?>" class="btn btn-icon btn-outline-danger" onclick="return confirm('Are You Really Want To Delete This Profile Photo..?  Click OK To Confirm...?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                  <br>
...
<div id="myModal4" class="modal " role="dialog" style="margin-top: 100px;">
            ...
            <div class="modal-body modalb">      
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Profile Photo Approved Sucessfully</h2>
                    </div>
                    <div class="swal2-actions">
                        <a href="photo_approve" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
            ...
            <div class="modal-body modalb">    
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Profile Photo Deleted Successfully</h2>
                    </div>
                    <div class="swal2-actions">
                        <a href="photo_approve" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
...
<?php if($_GET['msg']=='delete'){ ?>
<div id="myModal3" class="modal " role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">      
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
