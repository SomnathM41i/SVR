                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center m-l-0">
                                <div class="col-sm-6">
                                    <h3> Add Institute Of IIT/IIM/NIT</h3>
                                </div>
                                <div class="col-sm-6 text-end">
                                    <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report12" data-id="1"><i class="feather icon-plus"></i> Add Institute</button>
                                </div>
                        ...
                        <div class="table-responsive"  id="content">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <?php  
                                    $id=$_GET['Iid'];
                                    $allrec=mysqli_query($con,"select * from iit ORDER BY Inst_nm ASC");
                                    ...
                                    <tr>
                                        ...
                                        <td ><a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal-report2" data-id="<?php echo $data['Iid'];?>">
                                                ...
                                                <?php if($data['Status']=="enable")
                                                    {
                                                        ?>
                                                <a href="delete_institute?flag=1&id=<?php echo $data['Iid'];?>" class="btn btn-danger btn-sm ml-3" >Inactivate
                                              </a>
                                                <?php
                                                    }
                                                    else
                                                ...
                                                ?>
                                                    <a href="delete_institute?flag=0&id=<?php echo $data['Iid'];?>" class="btn btn-danger btn-sm ml-3" >Activate
                                                    </a>
                                                <?php 
                                                    }
                                                ?>
...
<div id="insModal" class="modal" role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">   
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    ...
                    <div class="swal2-actions">
                        <a href="add_institue" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php 
                            ...
                            {
                        ?> 
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Institute Inactivated Successfully</h2>
                        <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Institute Actived Successfully</h2>
                        <?php        
                            }
                        ?>
                    </div>
