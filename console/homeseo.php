...
<?php  
	...
	if(isset($_POST['submit']))
	{
		...
		//header('location:homeseo.php?catagory=home&msg=success');
	} 
?>
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<div class="col-sm-12">
										   ...
										   <input type="" class="form-control" name="title" value="<?php echo $res['title'];?>" placeholder="Enter your website name  Ex: welcome to your domain name " maxlength="60">
								</div><br>
								 <div class="col-sm-12">
    		...
    		<div class="modal-body modalb">
				<div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
					...
					<div class="swal2-actions">
						<a href="homeseo?catagory=home" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
      				</div>
    			</div> 
			</div>
		</div>   
