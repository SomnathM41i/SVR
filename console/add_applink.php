...
<head>
    ...
    <title>Add Androidapp Link</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="container">
                            ...
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#!">Android Link</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Link</li>
                            </ol>
                        </nav> 
                                           <input type="text" class="form-control" name="link" value="<?php echo $res['content']?>">
                                 </div>
                            </div>
            ...
            <div class="modal-body modalb">  
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Android Link Updated Successfully</h2>
                    </div>
                    <div class="swal2-actions">
                       <a href="add_applink" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
