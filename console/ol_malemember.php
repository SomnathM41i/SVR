...
$result=mysqli_query($con,"select * from register where Gender='Male' and TIMESTAMPDIFF(minute,LastLogin,NOW())<5  order by ID desc");
				//echo "select * from register where TIMESTAMPDIFF(minute, last_seen,now() ) < 5 and Gender='Female'  order by ID desc";
?>
...
<head>
    ...
    <title>Online Male Member</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Online Male Member</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable_ol_male" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
