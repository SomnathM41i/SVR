...
$msg="";
	...
	{
		$religion=mysqli_real_escape_string($con,$_POST['Name']);
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add Religion</button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
								<?php  
										  $allrec=mysqli_query($con,"select * from religion");
											...
											<tr>
											  ...
											  <td >
											    ...
											    <?php
                                                    ...
                                                    {
                                                ?>
                                                <a href="delete_religion?flag=1&id=<?php  echo $data['ID'];?>" class="btn btn-danger btn-sm ml-3" >Inactivate</a>
                                                <?php
                                                    }
                                                    else
                                                    {
                                                ?>
                                                <a href="delete_religion?flag=0&id=<?php  echo $data['ID'];?>" class="btn btn-danger btn-sm ml-3" >Activate</a></td>
                                                <?php
                                                    }
                                                ?>
                                            </tr>
...
<script>
$(document).ready(function(){
    $('#modal-report1').on('show.bs.modal', function (e) {
        var rowid = $(e.relatedTarget).data('id');
        $.ajax({
            type : 'post',
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
	                ...
	                <div class="swal2-actions">
	                   ...
	                   <a href="add_religion" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php
                            ...
                            {
                        ?>
	                   <h2 class="swal2-title" id="swal2-title" style="display: flex;">Religion Inactivated Successfully</h2>
	                   <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Religion Activated Successfully</h2>
