...
{
    svr_console_cms_save_content($con, $db, '4');
                        ...
                        <div class="container">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Description</li>
                                  ...
                                  <textarea class="ckeditor" cols="80" id="editor1" name="Message" rows="10"><?php  echo $res['content']; ?> </textarea>
     ...
     <div class="modal-body modalb">   
        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
            <div class="swal2-header">
                ...
                <h2 class="swal2-title" id="swal2-title" style="display: flex;">Terms And Conditions Updated Successfully</h2>
            </div>
            <div class="swal2-actions">
               <a href="add_terms" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
            </div>
        </div> 
    </div>
</div>   
