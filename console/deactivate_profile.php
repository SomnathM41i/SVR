...
require_once(dirname(__FILE__).'/protect.php');
  ...
  error_reporting(0);
  $result=mysqli_query($con,"SELECT * FROM register where Status ='Banned' and deletestatus='1' order by ID desc");
?>
...
<head>
    ...
    <title>Banned Male Member</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Banned Male Member</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable_ban_male" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
...
<script>
    ...
    $('#simpletable_ban_male').DataTable({
     "order": [[ 1, "desc" ]],
