<?php require_once('../sys_dbconnection.php'); 
  ...
  error_reporting(0);
  $result=mysqli_query($con,"SELECT * FROM register where Status ='Expired' and Gender='Female' order by ID desc");
?>
...
<head>
    ...
    <title>Membership Expired Female</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Membership Expired Female</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable_expire_female" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
...
<script>
    ...
    $('#simpletable_expire_female').DataTable({
     "order": [[ 1, "desc" ]],
