...
require_once(dirname(__FILE__).'/protect.php');
    ...
    {
        $occu=mysqli_real_escape_string($con,$_POST['Name']);
        $q="select * from occupation where occu='$occu'";
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add Occupation</button>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td ><a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal-report2" data-id="<?php echo $data['id'];?>">Edit </a>
                                                    <?php if($data['status'] == 'enable')
                                                        {
                                                    ?>
                                                    <a href="delete_occupation?flag=1&id=<?php echo $data['id'];?>" class="btn btn-danger btn-sm ml-3" >Inactivate</a>
                                                    <?php 
                                                        }
                                                        else
                                                        {
                                                    ?>
                                                    <a href="delete_occupation?flag=0&id=<?php echo $data['id'];?>" class="btn btn-danger btn-sm ml-3" >Activate</a>
...
<div id="occuModal" class="modal " role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">   
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    ...
                    <div class="swal2-actions">
                        <a href="add_occupation" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
            ...
            <div class="modal-body modalb">   
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Occupation Inactivated Successfully</h2>
                        <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Occupation Activated Successfully</h2>
                        <?php
                            }
                        ?>
                    </div>
