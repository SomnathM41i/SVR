...
require_once(dirname(__FILE__).'/protect.php');
  ...
  error_reporting(0);
  $result=mysqli_query($con,"SELECT * FROM register where Status ='Active' and Gender='Male' order by ID desc");
?>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Free Male Member</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable_free_m" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
