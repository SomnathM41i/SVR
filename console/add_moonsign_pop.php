...
?>
 ...
 <div class="modal-header">
                <h5 class="modal-title">Add Moon Sign</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                <form action="add_moonsign?ID=<?php echo $id?>&msg=success" method="post">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <?php  $q="select * from education";
                             $rs=mysqli_query($con,$q); ?>
                                ...
                                <option value="" selected>Select Education </option>
                                  ...
                                  <?php */?>
                                <input type="text" class="form-control" id="Name" name="Name" placeholder="Enter Moon Sign" required>
