...
?>
 ...
 <div class="modal-header">
                <h5 class="modal-title">Profile Description Approval</h5> 
                <h5 class="modal-title"><span  class="spcss">ID:</span> <?php echo $id ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                <form action="profile_approval" method="post">
                    <div class="row">
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                         ...
                         <button class="btn btn-danger btn-sm btn-flat" type="submit" name="ignore">Decline</button>
                        </div>
                    </div>
                </form>
            </div>