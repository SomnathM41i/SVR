...
$profile_approve = mysqli_query($con,"SELECT * FROM document where docapprove='No' and  Name!='' order by doc_id desc LIMIT ".$pageLimit." , ".$setLimit);
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <div class="col-xl-3 col-md-4 col-sm-6 element-item graphic">
								...
								<?php $image = $profile_approve_row['Name'];  

									$fileextension = pathinfo($image, PATHINFO_EXTENSION);
									$contenttype = mime_content_type($image); 
									if($fileextension=="pdf") { ?>
									<iframe src="../document/<?php  echo $profile_approve_row['Name'] ?>" class="img-fluid img-thumbnail mb-3"> </iframe>
									<?php } else { ?>
									<a href="../document/<?php  echo $profile_approve_row['Name'] ?>" target="_blank">
                                <img src="../document/<?php  echo $profile_approve_row['Name'] ?>" class="img-fluid img-thumbnail mb-3">
									</a><?php } ?>
                                <a href="approve_document?docid=<?php echo $profile_approve_row['doc_id'];?>&MatriID=<?php echo $profile_approve_row['MatriID'];?>" class="btn btn-icon btn-outline-success"><i class="fa fa-check" aria-hidden="true"></i></a> &nbsp;&nbsp;
                                
                                <a href="delete_document_proof?docid=<?php echo $profile_approve_row['doc_id'];?>&MatriID=<?php echo $profile_approve_row['MatriID'];?>" class="btn btn-icon btn-outline-danger" onclick="return confirm('Are You Really Want To Delete This Document..?  Click OK To Confirm...?')"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                  
								 <?php  if($fileextension=="pdf") {?>
										<a href="../document/<?php  echo $profile_approve_row['Name'] ?>" class="btn btn-icon btn-outline-info" target="_blank"> <i class="fa fa-info"></i> </a>
								 <?php } ?> 
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Document Approved Sucessfully</h2>
                    </div>
                    <div class="swal2-actions">
    
                        <a href="document_approval" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Document Deleted Successfully</h2>
                    </div>
                    <div class="swal2-actions">
                        <a href="document_approval" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
