            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Today's Member</h5>
                    </div>
                    <div class="card-body">
					   
                        <div class="dt-responsive table-responsive">
						 <form action="todaymember_list" method="post">
                       <strong>From Date</strong> <input type="date"  name="datefrom" class="incs"> <strong class="stcs">To Date</strong> <input type="date"  name="dateto" class="incs" > 
										 <button type="submit" class="btn btn-primary stcs"  name="submit">Sumbit</button>
                           <!--<input type="submit" value="Submit" class="btn btn-default">-->
						   </form> <br>
                            <table id="simpletable_today_mem" class="table table-striped table-bordered nowrap">
                            	<thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
                                ...
                                <tbody>
                                   ...
                                   <?php  
								   $result=mysqli_query($con,"SELECT *  FROM register where Regdate='".$date."'");
								   while($row =mysqli_fetch_assoc($result)){ ?>
										...
										?>
										  <td><a href="profile_view.php?ID=<?php  echo $row['MatriID'];?>"><?php  echo $row['MatriID'];?><br> Manage:<?php  echo $row['Profilecreatedby'];?></a></td>
										  ...
										  $explodedatedisplay1=$explodedate1[2]."-".$explodedate1[1]."-".$explodedate1[0];echo $explodedatedisplay1;?>
										  <br> Status:<?php  echo $row['Status'];?></td>
...
<script>
    ...
    $('#simpletable_today_mem').DataTable({
     "order": [[ 1, "desc" ]],
