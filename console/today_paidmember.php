...
require_once(dirname(__FILE__).'/protect.php');
  ...
  $date = date('Y-m-d');
 $result=mysqli_query($con,"select a.*,b.*  from register a,paiddetails b where b.Pactivedate='".$date."' and a.MatriID=b.Pmatriid");
?>
...
<head>
    ...
    <title>Today's Paid Member</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Today's Paid Member</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
						 <form action="today_paid_member" method="post">
								    <strong>From Date</strong> <input type="date"  name="datefrom" class="incs" value="<?php  echo $datefrom ?>"> <strong class="stcs">To Date</strong> <input type="date"  name="dateto" class="incs" value="<?php  echo $dateto ?>"> 
