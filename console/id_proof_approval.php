...
$profile_approve = mysqli_query($con,"SELECT * FROM register where idproof_approve='No' and  adhar!='' order by id desc LIMIT ".$pageLimit." , ".$setLimit);
                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <div class="col-xl-3 col-md-4 col-sm-6 element-item graphic">
                                ...
                                <?php $image = $profile_approve_row['adhar'];  

                                    $fileextension = pathinfo($image, PATHINFO_EXTENSION);
                                    $contenttype = mime_content_type($image); 
                                    if($fileextension=="pdf") {?>
                                    <iframe src="../adhar/<?php  echo $profile_approve_row['adhar'] ?>" class="img-fluid img-thumbnail mb-3"></iframe>
                                    <?php } else { ?>
                                    <a href="../adhar/<?php  echo $profile_approve_row['adhar'] ?>" target="_BLANK">
                                        <img src="../adhar/<?php  echo $profile_approve_row['adhar'] ?>" class="img-fluid img-thumbnail mb-3">
                                    </a>
                                    <?php } ?>
							   ...
							   <a href="../adhar/<?php  echo $profile_approve_row['adhar'] ?>" class="btn btn-icon btn-outline-info" target="_blank"> <i class="fa fa-info"></i> </a>
							   <?php } ?>
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">ID Proof Approved Sucessfully</h2>
                    </div>
                    <div class="swal2-actions">
                        <a href="id_proof_approval" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">ID Proof Deleted Successfully</h2>
                    </div>
                    <div class="swal2-actions">
                        <a href="id_proof_approval" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
