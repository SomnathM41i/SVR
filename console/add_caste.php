...
if(isset($_POST['Update']))
{
    ...
    $q="select * from religion ORDER BY Religion ASC";
    $rs=mysqli_query($con,$q);
    $num=mysqli_num_rows($rs);
?>
...
<head>
    ...
    function get_state(id)
    {
        ...
        xmlhttp.open("GET","get_caste?id="+id,true);
        xmlhttp.send();
    }
    </script>
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add Caste</button>
                            </div>
                            <div class="col-sm-12">
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
	                ...
	                <div class="swal2-actions">
	                   <a href="add_caste" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
        ...
        <div class="modal-content">     
            <div class="modal-body modalb">     
                ...
                <div class="swal2-header">
                    ...
                    <?php if($check==1){
                    ?>
	                <h2 class="swal2-title" id="swal2-title" style="display: flex;">Caste Inactivated Successfully</h2>
                    <?php }else{
                    ?>
                    <h2 class="swal2-title" id="swal2-title" style="display: flex;">Caste Activated Successfully</h2>
                    <?php }
                    ?>
	            </div>
	            <div class="swal2-actions">
