...
{
    $residency_status=mysqli_real_escape_string($con,$_POST['Name']);
    
    
    
    
    
    $q="select * from residency_status where residency_status='$residency_status'";
    ...
    if($num>0)
    {
         $msg="Residency Status Field already Exist!!";
    }
    else
    {
...
if(isset($_POST['Update']))
{
    ...
    else
    {
        ...
        $q="select * from residency_status";
        $rs=mysqli_query($con,$q);
        $num=mysqli_num_rows($rs);
...
<head>
    <title>Add Residency Status</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            <div class="col-sm-6">
                              <h3>Add Residency Status </h3>
                            </div>
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add Residency Status </button>
                            </div>
                        ...
                        <div class="table-responsive"  id="content">
                            ...
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                <thead>
                                    <tr>
                                        <!--<th>Sr. No.</th>-->
                                          <th width="829px">Residency Status</th>
                                ...
                                <?php  
                                          ...
                                          $allrec=mysqli_query($con,"select * from residency_status ORDER BY residency_status ASC");
                                          ...
                                          while($data=mysqli_fetch_assoc($allrec) and $i<$total)
                                          {
                                           ?>
                                            <tr>
                                              ...
                                              <td><?php  echo $data['residency_status'];?></td>
                                              <td >
                                              ...
                                              <?php
                                                    ...
                                                    {
                                                ?>
                                              <a href="delete_residency_status?flag=1&id=<?php echo $data['id'];?>" class="btn btn-danger btn-sm ml-3">Inactivate</a></td>
                                                <?php 
                                                    }
                                                    else
                                                    {
                                                ?>
                                                <a href="delete_residency_status?flag=0&id=<?php echo $data['id'];?>" class="btn btn-danger btn-sm ml-3">Activate</a></td>
                                                <?php 
                                                    }
                                                ?>
                                            </tr>
...
$(document).ready(function(){
    $('#modal-report').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'add_residencystatus_pop', //Here you will fetch records 
            data :  'rowid='+ rowid, 
...
$(document).ready(function(){
    $('#modal-report2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'edit_residencystatus_pop', //Here you will fetch records 
            data :  'rowid='+ rowid, 
            success : function(data){
            $('.modal-content').html(data);//Show fetched data from database
            }
            ...
            <div class="modal-body modalb">   
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    ...
                    <div class="swal2-actions">
                        <a href="add_residency_status" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php
                            ...
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Residency Status Inactivated Successfully</h2>
                        <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Residency Status Activated Successfully</h2>
                        <?php
                            }
                        ?>
                    </div>
