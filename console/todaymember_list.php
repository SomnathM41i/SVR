...
$result=mysqli_query($con,"select * from register  where Regdate Between '".$datefrom."' and '".$dateto."' order by ID DESC");
?>
                    ...
                    <div class="card-body">
						...
						<?php  
								   $a = explode('-',$_POST["datefrom"]);
									...
									$todate = $a[2].'-'.$a[1].'-'.$a[0];
								   ?>
									<h5 class="box-title">Members From <u><?php  echo $fromdate ?></u> To <u><?php   echo $todate?></u></h5><br>
                            ...
                            <table id="simpletable_mem_list" class="table table-striped table-bordered nowrap">
...
<script>
    ...
    $('#simpletable_mem_list').DataTable({
     "order": [[ 1, "desc" ]],
