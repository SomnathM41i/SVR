...
<?php  
    ...
    if(isset($_POST['submit']))
    {
        ...
        //header('location:aboutusseo.php?catagory=aboutus&msg=success1');
    } 
?>
                                ...
                                <div class="col-sm-12">
                                 ...
                                 <div class="col-sm-12">
                                   ...
                                   <div class="col-sm-12">
                                           ...
                                           <textarea class="form-control" name="keyword"  placeholder="Enter few keywords for finding your website on search result. Ex: Matrimony Site,Hindu Matrimony,Hindu Groom's,etc." onkeyup="nospaces(this);nospaceses(this);nospaceses1(this)"><?php echo $res['keyword']; ?></textarea>
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    ...
                    <div class="swal2-actions">
                       <a href="aboutusseo?catagory=aboutus" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
