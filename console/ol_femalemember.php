...
<head>
    ...
    <title>Online Female Member</title>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Online Female Member</h5>
                    </div>
                    <div class="card-body">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable_ol_female" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
										  <th>Profile ID</th>
										  <th>Name/Email</th>
...
<script>
    ...
    $('#simpletable_ol_female').DataTable({
     "order": [[ 1, "desc" ]],
