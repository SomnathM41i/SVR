    ...
    <div class="pcoded-content">
        ...
        <div class="row">
			...
			<?php if(isset($_POST['submit']))
					...
					header('location:sample.php?msg=abous');
									}
...
<div class="swal2-success-circular-line-left" style="background-color: rgb(255, 255, 255);"></div>
	...
	<h2 class="swal2-title" id="swal2-title" style="display: flex;">AboutUs Updated Successfully</h2>
	</div>
	<div class="swal2-actions">
	
	<a href="sample.php" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
      </div>
    </div> 
