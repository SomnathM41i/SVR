...
<head>
    <title>Partener Expectation Approval</title>
            ...
            <div class="col-xl-12">
                <div class="card">
                     <div class="card-header">
                        <h5>Partener Expectation Approval</h5>
                    </div>
                    <div class="card-body">
...
<div id="myModal8" class="modal " role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Partner Expectation Approved Successfully</h2>
                   </div>
                   <div class="swal2-actions">
                       <a href="partener_expectation" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
            ...
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Partner Expectation Declined Successfully</h2>
                    </div>
                    <div class="swal2-actions">
                        <a href="partener_expectation" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
