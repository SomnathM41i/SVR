...
xmlhttp.open("GET","get_dist?id="+id,true);
xmlhttp.send();
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
							...
							<div class="col-sm-12 ">
						    <form  name="country" id="country" method="post" action="add_dist">
...
<div id="myModal2" class="modal " role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">     
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
	                ...
	                <div class="swal2-actions">
    	               <a href="add_dist" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php
                            ...
                            {
                        ?>
	                    <h2 class="swal2-title" id="swal2-title" style="display: flex;">District Inactivated Successfully</h2>
	                    <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">District Activated Successfully</h2>
	                    <?php
                            }
                        ?>
                    </div>
