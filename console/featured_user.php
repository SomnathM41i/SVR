                    ...
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Set Featured User</button>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <tbody>
								 <?php  
									  $allrec=mysqli_query($con,"select * from register where featured_user='yes'");
									  ...
									  
									  {
									   ?>
											<tr>
											  <td><?php  echo $i+1;?></td>
											  <td><?php  echo $data['MatriID'];?></td>
											  <td><?php  echo $data['Name'];?></td>
											  <td><?php  echo $data['Gender'];?></td>
											  <td align="center"><a href="delete_featured_user.php?id=<?php  echo $data['MatriID'];?>" class="btn btn-danger btn-sm ml-3">Remove From List</a></td>											
											  </tr>
											<?php  
										  $i++;
										  }
...
<div class="swal2-success-circular-line-left" style="background-color: rgb(255, 255, 255);"></div>
  ...
  <h2 class="swal2-title" id="swal2-title" style="display: flex;"> <?PHP echo $ID ?> Promoted as Featured User</h2>
  </div>
  <div class="swal2-actions">
  
  <a href="featured_user.php" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
    </div>
  </div> 
</div>
</div>   
