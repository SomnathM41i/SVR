...
{
    $employed=mysqli_real_escape_string($con,$_POST['Name']);
    //echo $caste;
    
    //$Religion=mysqli_real_escape_string($con,$_POST['religion']);
    //echo $Religion;
    
    $q="select * from employed_in where employed='$employed'";
    ...
    if($num>0)
    {
        $msg="Emplyoed In Field already Exist!!";
        //$msg=0;
    ...
    else
    {
        ...
        {
            //$msg=1;
            $msg="New Employed Field field added Successfully!!";
        }
    }
}
...
if(isset($_POST['Update']))
{
    ...
    {
        //$msg=0;
        $msg="Employed In Field already Exist!!";
        //echo $msg;
    }
    else
    {
...
<head>
    <title>Add New Employed in Field</title>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row align-items-center m-l-0">
                            <div class="col-sm-6">
                              <h3> Add New Employed in </h3>
                            </div>
                            <div class="col-sm-6 text-end">
                                <button class="btn btn-success btn-sm mb-3 btn-round" data-bs-toggle="modal" data-bs-target="#modal-report" data-id="1"><i class="feather icon-plus"></i> Add New Employed in </button>
                            </div>
                        ...
                        <div class="table-responsive"  id="content">
                            ...
                            <table id="report-table" class="table table-bordered table-striped mb-0">
                                ...
                                <?php  
                                          ...
                                          $allrec=mysqli_query($con,"select * from employed_in ORDER BY employed ASC");
                                            ...
                                            <tr>
                                              ...
                                              <td ><a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#modal-report2" data-id="<?php echo $data['id'];?>">Edit </a>
                                                <?php 
                                                    ...
                                                    {
                                                ?>
                                                <a href="delete_employed_in?flag=1&id=<?php echo $data['id'];?>"  class="btn btn-danger btn-sm ml-3">Inactivate</a>
                                                <?php
                                                    }
                                                    else
                                                    {
                                                ?>
                                                <a href="delete_employed_in?flag=0&id=<?php echo $data['id'];?>"  class="btn btn-danger btn-sm ml-3">Activate</a>
                                                <?php
                                                    }
                                                ?>
                                              </td>
...
$(document).ready(function(){
    $('#modal-report').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'add_employedin_pop', //Here you will fetch records 
...
$(document).ready(function(){
    $('#modal-report2').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            type : 'post',
            url : 'edit_employedin_pop', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.modal-content').html(data);//Show fetched data from database
            }
...
<div id="empModal" class="modal " role="dialog" style="margin-top: 100px;">
    <div class="modal-dialog">
        <div class="modal-content">     
            <div class="modal-body modalb">   
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    ...
                    <div class="swal2-actions">
                        <a href="add_employed_in" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
                    </div>
                </div> 
            </div>
        </div>   
                ...
                <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                    <div class="swal2-header">
                        ...
                        <?php
                            ...
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Employed in Field Inactivated Successfully</h2>
                        <?php
                            }
                            else
                            {
                        ?>
                        <h2 class="swal2-title" id="swal2-title" style="display: flex;">Employed in Field Activated Successfully</h2>
                        <?php
                            }
                        ?>
                    </div>
