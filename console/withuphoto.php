    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
				<div class="card-body">
					<form action="withoutphotoreport" method="post">
					   <div class="row align-items-center m-l-0">
                            <div class="col-sm-6">
							  <h3>Without Photo Status Report</h3>
                            </div>
						   ...
						   <div class="dt-responsive table-responsive">
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
								...
								<?php  
									$relsql=$con->query("select * from register where Photo1='nophoto.jpg'");
									...
									$photo=$relrow['Photo1'];
									?>
									<td><a href="profile_view.php?ID=<?php echo $matriid;?>"><?php echo $matriid;?></a></td>
									<td><?php if($relrow['Photo1']=="nophoto.jpg")
									{  echo  "No";  }  ?>
									</td>
									<td><?php if($relrow1['Photo1']!="nophoto.jpg"){ ?>
												<img src="../images/<?php echo $photo?>" style="height:80px;width:80px;">
												<?php } ?></td>
