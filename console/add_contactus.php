                        ...
                        <div class="container">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <div class="col-sm-12">
                                           ...
                                           <textarea class="form-control" name="add" maxlength="350" rows="3"><?php echo$res['content']?></textarea>
                                           
                                 </div><br>
                                 <div class="col-sm-12">
                                       
                                           <label class="form-label">Email :</label>
                                           <input type="email" class="form-control" name="mail" value="<?php echo $res['email']?>">
                                 </div><br>
                                  <div class="col-sm-12">
                                       
                                           <label class="form-label">Mobile No :</label>
                                           <input type="text" class="form-control" name="mob" value="<?php echo $res['mobile']?>"  maxlength="10" oninput="maxLengthCheck(this)"  onkeypress="return isNumber(event)" >
                                 </div><br>
                                  <div class="col-sm-12">
                                       
                                           <label class="form-label">Whatsapp/Another No :</label>
                                           <input type="text" class="form-control" name="mob2" value="<?php echo $res['whatsapp']?>"  maxlength="10"  oninput="maxLengthCheck(this)"  onkeypress="return isNumber(event)">
                                 </div><br>
                                   <div class="col-sm-12">
                                       
                                           <label class="form-label">Office Time :</label>
                                           <input type="text" class="form-control" name="offtim" value="<?php echo $res['officetime']?>">
                                 </div>
                            </div><br>
        ...
        <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-icon-success swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
          <div class="swal2-header">
            <div class="swal2-icon swal2-success swal2-icon-show" style="display: flex;">
              ...
              <h2 class="swal2-title" id="swal2-title" style="display: flex;">Contact Us Updated Successfully</h2>
            </div>
            <div class="swal2-actions">
             <a href="add_contactus" data-target="#" class="swal2-confirm swal2-styled"  style="display: inline-block;">OK</a>
          </div>
        </div> 
      </div>
    </div>   
