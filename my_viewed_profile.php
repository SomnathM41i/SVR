...
<main class="mvv-page">
  <section class="mvv-page-hero">
    <div class="mvv-container">
      ...
      <h1>My Viewed Profile</h1>
      <p>तुम्ही पाहिलेली प्रोफाइल्स</p>
      <nav class="mvv-breadcrumb" aria-label="breadcrumb">
        <a href="index_dashboard">Home</a>
        <span>My Viewed Profile</span>
      </nav>
    </div>
  </section>
...
$sql="select whom,date from profile_views where who='$login' And whom NOT IN('$profile') And whom NOT IN ('$matriid')LIMIT $start_from, $limit";
$sql1="SELECT COUNT(*) as totalCount  FROM  profile_views where  who='$login' And whom NOT IN('$profile') And whom NOT IN ('$matriid') ";
		 ...
		 <?php if($limit<$total_records) { ?>  
						...
						<div align="center" class="col-lg-12">
							...
							<?php if($page > 1){ 
								...
								<li id="<?php echo $i;?>"></li>
							<?php }         ?>
							 <li>Page <?php echo $page?> of <?php echo $total_pages?></li>
							<?php if(!empty($total_pages)):for($i=1; $i<=$total_pages; $i++):  
										if($i == $_GET['page']):?>
									   <li id="<?php echo $i;?>"><a  class='active' href='my_viewed_profile?page=<?php echo $i;?>' ><?php echo $i;?></a></li> 
										
										<?php else:?>
										<li id="<?php echo $i;?>" ><a href='my_viewed_profile?page=<?php echo $i;?>' ><?php echo $i;?></a></li>
							...
							if($page < $total_pages){ 
								...
								<li id="<?php echo $i;?>"><a href='my_viewed_profile?page=<?php echo $next;?>' ><span class="icon fa fa-angle-right"></span></a></li>
							</a></li>
							<?php }         ?><?php endif;?> 
							 </ul>
							 </div></div>
